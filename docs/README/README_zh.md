...
天机阁是一个以自由软件精神为内核、以开源协作为方式的开发者团体&东方Project同人社团。  
...
2. 服务东方社群：为东方社群产出相关工具和平台。
3. 互相托底：成员之间可以批评代码，但不攻击人；可以争论技术，但不上升立场；可以累了休息，但不嘲讽还在跑的人。
4. 向外连接：愿意和其他开源团队、其他国家的开发者协作。
...
2. 一个可以不用站队的地方
3. 一个可以改变世界的地方
4. **部署资源**：团队拥有 Cloudflare 域名，可以作为部署静态网站的免费资源
5. **免费部署帮助**：代理阁主（baby2016）可以免费帮助部署动态网站
